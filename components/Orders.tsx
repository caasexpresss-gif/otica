...
import { Plus, Search, Filter, MoreHorizontal, ArrowRight, CheckCircle, DollarSign, Save, X, Calendar, AlertCircle, Info } from 'lucide-react';
...
const Orders: React.FC = () => {
  ...
  const handleSaveOrder = () => {
    ...
    const customer = MOCK_CUSTOMERS.find(c => c.id === newOrder.customerId);
